...
(self.webpackChunkandeplane_pyodide_kernel_extension =
  ...
  {
    763: (e, l, n) => {
      n.r(l), n.d(l, { KERNEL_SETTINGS_SCHEMA: () => o, default: () => p });
      var t = n(671),
        s = n(174),
        i = n(289),
        a = n(685);
      const r = n.p + 'schema/kernel.v0.schema.json';
      var o = n.t(r);
      const h = `data:image/svg+xml;base64,${btoa(
        ...
        d = 'andeplane-pyodide-kernel-extension:kernel',
        p = [
          {
            id: d,
            autoStart: !0,
            ...
            activate: (e, l, s, i) => {
              const a =
                  JSON.parse(t.PageConfig.getOption('litePluginSettings') || '{}')[d] ||
                  {},
                r =
                  a.pyodideUrl ||
                  'https://cdn.jsdelivr.net/pyodide/v0.23.1/full/pyodide.js',
                o = t.URLExt.parse(r).href,
                p = a.pipliteWheelUrl ? t.URLExt.parse(a.pipliteWheelUrl).href : void 0,
                c = (a.pipliteUrls || []).map((e) => t.URLExt.parse(e).href),
                v = !!a.disablePyPIFallback;
              l.register({
                spec: {
                  name: 'python',
                  ...
                  language: 'python',
                  argv: [],
                  resources: { 'logo-32x32': h, 'logo-64x64': h },
                },
                create: async (e) => {
                  const { PyodideKernel: l } = await n
                      .e(133)
                      .then(n.t.bind(n, 133, 23)),
                    t = !(
...
//# sourceMappingURL=652.5b01f737d28e86ce0dc6.js.map?v=5b01f737d28e86ce0dc6
