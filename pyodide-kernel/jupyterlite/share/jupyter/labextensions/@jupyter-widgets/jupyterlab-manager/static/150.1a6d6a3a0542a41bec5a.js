    ...
    6110: (e, t, o) => {
      ...
      function i(e) {
        ...
        for (let o = 0; o < e.length; o += 2)
          t[o / 2] = parseInt(e.slice(o, o + 2), 16);
        return t.buffer;
      }
      function m(e) {
      ...
      class v {
        ...
        create_view(e, t = {}) {
          const o = (0, s.uuid)(),
            n = (e.state_change = e.state_change.then(async () => {
              ...
              try {
                const s = new (await this.loadViewClass(
                  n,
                  r,
                  e.get('_view_module_version')
                ))({ model: e, options: this.setViewOptions(t) });
                return (
                ...
                const l = `Failed to create view for '${n}' from module '${r}' with model '${e.name}' from module '${e.module}'`,
                  ...
                  i = new s.ErrorWidgetView({
                    model: a,
                    options: this.setViewOptions(t),
                  });
        ...
        handle_comm_open(e, t) {
          ...
          return (
            ...
            this.new_model(
              {
                model_name: n.state._model_name,
                model_module: n.state._model_module,
                model_module_version: n.state._model_module_version,
                comm: e,
              },
              n.state
        ...
        new_widget(e, t = {}) {
          ...
          return o.then(
            (e) => (
              (n.comm = e), this.new_model(n, t).then((e) => (e.sync('create', e), e))
            ),
        ...
        async new_model(e, t = {}) {
          var o, s;
          const n =
            null !== (o = e.model_id) && void 0 !== o
              ? o
              : null === (s = e.comm) || void 0 === s
              ? void 0
              : s.comm_id;
          if (!n)
            throw new Error(
        ...
        async _loadFromKernel() {
          ...
          const l = await Promise.all(
            Object.keys(o).map(async (e) => ({
              widget_id: e,
              comm: this.has_model(e)
                ? void 0
                : await this._create_comm('jupyter.widget', e),
            }))
          );
          await Promise.all(
                  ...
                  await this.new_model(
                    {
                      ...
                      model_module: l.model_module,
                      model_module_version: l.model_module_version,
                      model_id: e,
                      comm: t,
                    },
                    l.state
        ...
        async _make_model(e, t = {}) {
          ...
          if (!r) {
            ...
            return (
              ...
              l(
                new Error(
                  `Cannot find model module ${e.model_module}@${e.model_module_version}, ${e.model_name}`
                ),
                t
              )
            );
          ...
          try {
            ...
            console.error(t),
              (a = l(
                t,
                `Model class '${e.model_name}' from module '${e.model_module}' is loaded but can not be instantiated`
              ));
          }
        ...
        clear_state() {
          return (0, s.resolvePromisesDict)(this._models).then((e) => {
            Object.keys(e).forEach((t) => e[t].close()),
              (this._models = Object.create(null));
          });
        }
        get_state(e = {}) {
          ...
          return this._get_comm_info().then((e) =>
            Promise.all(
              Object.keys(t).map((o) => {
                ...
                if (this.has_model(o))
                  return this.get_model(o).then((e) =>
                    e.constructor
                      ._deserialize_state(l || {}, this)
                      .then((t) => (e.set_state(t), e))
                  );
                const a = {
                  model_id: o,
                  model_name: r.model_name,
                  model_module: r.model_module,
                  model_module_version: r.model_module_version,
                };
                return Object.prototype.hasOwnProperty.call(e, 'model_id')
                  ? this._create_comm(this.comm_target_name, o).then(
                      (e) => ((a.comm = e), this.new_model(a))
                    )
                  : this.new_model(a, l);
              })
            )
            ...
            for (let e = 1, i = a.length; e < i; e += 2) {
              ...
              '@' === i.charAt(0)
                ...
                ? i === n
                  ? l
                    ? (r = e)
                    : ((a = _(s, e, o, t, a)), (s = null), (n = null), (r = null))
                  : i.match(/\n.*\n/)
                  ? (null !== r && ((e = r), (a = _(s, e, o, t, a))),
                    (s = null),
                    (n = null),
                    (r = null),
                    (l = 0))
                ...
                ? ((s = e), (n = '(' === i.slice(-1) ? '\\\\)' : '\\\\]'), (l = 0))
                : 'begin' === i.substr(1, 5) &&
                  ((s = e), (n = '\\end' + i.substr(6)), (l = 0));
            }
            return (
              null !== s &&
                null !== r &&
                ((a = _(s, r, o, t, a)), (s = null), (n = null), (r = null)),
              { text: o(a.join('')), math: t }
            );
          })(e);
          var o, s, n;
          return (
