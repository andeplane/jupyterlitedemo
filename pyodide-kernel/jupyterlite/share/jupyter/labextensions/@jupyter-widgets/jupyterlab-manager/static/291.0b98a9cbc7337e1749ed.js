      ...
      !(function (t, n) {
        ...
        (S.filter = function (e, t, n) {
          ...
          S.fn.extend({
            ...
            is: function (e) {
              return !!L(this, 'string' == typeof e && N.test(e) ? S(e) : e || [], !1)
                .length;
            },
          });
        var H,
              ...
              return (
                S.each(t, function (e, r) {
                  ...
                  (i[r[1]] = a.add),
                    ...
                    (o[r[0]] = function () {
                      return (
                        o[r[0] + 'With'](this === o ? void 0 : this, arguments), this
                      );
                    }),
        ...
        ae.getRootNode &&
          (se = function (e) {
            return (
              S.contains(e.ownerDocument, e) || e.getRootNode(ue) === e.ownerDocument
            );
          });
        var le = function (e, t) {
          return (
          ...
          special: {
            ...
            click: {
              setup: function (e) {
                var t = this || e;
                return (
                  ve.test(t.type) && t.click && D(t, 'input') && Ne(t, 'click', Ee), !1
                );
              },
              trigger: function (e) {
                var t = this || e;
                return (
                  ve.test(t.type) && t.click && D(t, 'input') && Ne(t, 'click'), !0
                );
              },
              _default: function (e) {
                var t = e.target;
                return (
                  (ve.test(t.type) && t.click && D(t, 'input') && K.get(t, 'click')) ||
                  D(t, 'a')
                );
              },
            },
        ...
        function Ie(e, t, n, r) {
          ...
          if (
            ...
            for (s = (a = S.map(be(i, 'script'), Oe)).length; f < p; f++)
              (l = i),
                f !== d && ((l = S.clone(l, !0, !0)), s && S.merge(a, be(l, 'script'))),
                n.call(e[f], l, f);
            if (s)
              for (c = a[a.length - 1].ownerDocument, S.map(a, Pe), f = 0; f < s; f++)
                (l = a[f]),
                  me.test(l.type || '') &&
            ...
            'margin' === n && (u += S.css(e, n + oe[a], !0, i)),
              r
                ? ('content' === n && (u -= S.css(e, 'padding' + oe[a], !0, i)),
                  'margin' !== n && (u -= S.css(e, 'border' + oe[a] + 'Width', !0, i)))
          ...
          S.fn.extend({
            addClass: function (e) {
              ...
              return y(e)
                ...
                ? this.each(function () {
                    if (
                      ((r = bt(this)), (n = 1 === this.nodeType && ' ' + xt(r) + ' '))
                    ) {
                    ...
                    if (s)
                      ...
                      (void 0 !== e && 'boolean' !== a) ||
                        ...
                        this.setAttribute &&
                          this.setAttribute(
                            'class',
                            r || !1 === e ? '' : K.get(this, '__className__') || ''
                          ));
                  }));
            },
            hasClass: function (e) {
          ...
          trigger: function (e, t, n, i) {
            ...
            if (
              ...
              3 !== n.nodeType &&
                ...
                ((e = e[S.expando]
                  ? e
                  : new S.Event(g, 'object' == typeof e && e)).isTrigger = i ? 2 : 3),
                (e.namespace = v.join('.')),
