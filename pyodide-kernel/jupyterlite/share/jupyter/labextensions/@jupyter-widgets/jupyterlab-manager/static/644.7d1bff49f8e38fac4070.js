  ...
  [644],
  {
        ...
        (i = function (t, e, n) {
          o.Backbone = (function (t, e, n, r) {
            ...
            var l = function (t, e, n, r) {
                if (n) {
                  var i = t[e] || (t[e] = []),
                    ...
                    a = r.listening;
                  a && a.count++,
                    i.push({ callback: n, context: o, ctx: o || s, listening: a });
                }
                return t;
              },
              h = function (t, e, n, r) {
            ...
            (a.once = function (t, e, n) {
              ...
              return (
                'string' == typeof t && null == n && (e = void 0), this.on(r, e, n)
              );
            }),
            ...
            n.extend(y.prototype, a, {
              ...
              set: function (t, e, r) {
                ...
                for (var f in i)
                  (e = i[f]),
                    ...
                    o ? delete c[f] : (c[f] = e);
                if (
                  (this.idAttribute in i && (this.id = this.get(this.idAttribute)), !s)
                ) {
                  a.length && (this._pending = r);
                  for (var p = 0; p < a.length; p++)
                    this.trigger('change:' + a[p], this, c[a[p]], r);
                }
                if (u) return this;
                if (!s)
                  for (; this._pending; )
              ...
              destroy: function (t) {
                ...
                return (
                  this.isNew()
                    ? n.defer(t.success)
                    : (L(this, t), (s = this.sync('delete', this, t))),
                  i || o(),
                  s
                );
              },
              url: function () {
                var t =
                  n.result(this, 'urlRoot') || n.result(this.collection, 'url') || q();
                ...
                if (null != t) {
                  ...
                  if (d) {
                    for (s = 0; s < this.length; s++)
                      h[(o = this.models[s]).cid] || l.push(o);
    ...
    1952: (t, e, n) => {
      ...
      t.exports = function (t, e, n, v, g, y) {
        ...
        if (O && !j)
          return (
            y || (y = new r()), _ || l(t) ? i(t, e, n, v, g, y) : o(t, e, b, n, v, g, y)
          );
        if (!(1 & n)) {
    ...
    4060: (t, e, n) => {
      ...
      function st(t, e) {
        ...
        var n = j.length,
          ...
          i = (C(r) && r.prototype) || a,
          o = 'constructor';
        for (J(t, o) && !e.contains(o) && e.push(o); n--; )
          (o = j[n]) in t && t[o] !== i[o] && !e.contains(o) && e.push(o);
      }
      function at(t) {
        if (!S(t)) return [];
        if (g) return g(t);
      ...
      function ut(t) {
        if (null == t) return !0;
        var e = ot(t);
        return 'number' == typeof e && (W(t) || T(t) || G(t))
          ? 0 === e
          : 0 === ot(at(t));
      }
      function ct(t, e) {
      ...
      function pt(t, e, n, r) {
        ...
        var i = typeof t;
        return (
          ('function' === i || 'object' === i || 'object' == typeof e) && dt(t, e, n, r)
        );
      }
      function dt(t, e, n, r) {
        ...
        if (!o) {
          ...
          if (
            s !== a &&
            !(C(s) && s instanceof s && C(a) && a instanceof a) &&
            'constructor' in t &&
            'constructor' in e
          )
            return !1;
      ...
      function de(t, e, n) {
        ...
        var r = RegExp(
            [
              (e.escape || ce).source,
              (e.interpolate || ce).source,
              (e.evaluate || ce).source,
            ].join('|') + '|$',
            'g'
          ),
          i = 0,
      ...
      function Me(t, e, n) {
        var r,
          ...
          u = function () {
            ...
            e > c
              ? (r = setTimeout(u, e - c))
              : ((r = null), n || (s = t.apply(a, o)), r || (o = a = null));
          },
          c = O(function (c) {
            return (
              (a = this),
              (o = c),
              (i = re()),
              r || ((r = setTimeout(u, e)), n && (s = t.apply(a, o))),
              s
            );
          });
        return (
      ...
      function $e(t, e, n) {
        e = Qt(e, n);
        for (var r, i = at(t), o = 0, s = i.length; o < s; o++)
      ...
      function Ke(t, e, n) {
        e = Qt(e, n);
        for (
          var r = !we(t) && at(t), i = (r || t).length, o = Array(i), s = 0;
          s < i;
          s++
        ) {
          var a = r ? r[s] : s;
      ...
      function nn(t, e, n, r) {
        return (
          we(t) || (t = kt(t)), ('number' != typeof n || r) && (n = 0), qe(t, e, n) >= 0
        );
      }
      ...
      function an(t, e, n) {
        ...
        if (null == e || ('number' == typeof e && 'object' != typeof t[0] && null != t))
          for (var a = 0, u = (t = we(t) ? t : kt(t)).length; a < u; a++)
            null != (r = t[a]) && r > o && (o = r);
        else
          (e = Qt(e, n)),
            Je(t, function (t, n, r) {
      ...
      const xn = O(function (t, e) {
          ...
          if (null == t) return n;
          C(r)
            ? (e.length > 1 && (r = Kt(r, e[1])), (e = gt(t)))
            : ((r = bn), (e = Oe(e, !1, !1)), (t = Object(t)));
      ...
      function Nn(t) {
        for (var e = (t && an(t, ot).length) || 0, n = Array(e), r = 0; r < e; r++)
          n[r] = on(t, r);
        return n;
      }
      const Rn = O(Nn);
