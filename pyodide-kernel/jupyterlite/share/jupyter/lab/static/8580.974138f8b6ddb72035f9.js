  ...
  [8580],
  {
    81899: (e, n, r) => {
      ...
      i.push([
        ...
        {
          version: 3,
          sources: ['webpack://./node_modules/codemirror/theme/neo.css'],
          names: [],
          mappings:
    ...
    94015: (e) => {
      ...
      function a(e, n) {
        ...
        var c, i;
        try {
          for (r = r.call(e); !(t = (c = r.next()).done); t = true) {
            o.push(c.value);
      ...
      e.exports = function e(r) {
        ...
        if (typeof btoa === 'function') {
          ...
          var s = '/*# '.concat(i, ' */');
          var u = a.sources.map(function (e) {
            return '/*# sourceURL='.concat(a.sourceRoot || '').concat(e, ' */');
          });
          return [t].concat(u).concat([s]).join('\n');
        }
        return [t].join('\n');
      };
    },
    ...
    93379: (e, n, r) => {
      ...
      function i(e, n) {
        ...
        for (var t = 0; t < e.length; t++) {
          ...
          if (A !== -1) {
            ...
            a.push({ identifier: l, updater: p(f, n), references: 1 });
          }
          o.push(l);
        }
        return o;
      ...
      function p(e, n) {
        ...
        if (n.singleton) {
          var a = m++;
          r = d || (d = s(n));
          o = A.bind(null, r, a, false);
          t = A.bind(null, r, a, true);
        } else {
          r = s(n);
          o = f.bind(null, r, n);
          t = function e() {
