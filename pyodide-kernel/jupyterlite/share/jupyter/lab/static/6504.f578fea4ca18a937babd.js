(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6504],
  {
    ...
    94015: (r) => {
      ...
      function t(r, o) {
        if (!r) return;
        if (typeof r === 'string') return i(r, o);
      ...
      function i(r, o) {
        ...
        for (var e = 0, t = new Array(o); e < o; e++) {
          t[e] = r[e];
        }
        return t;
      }
      ...
      r.exports = function r(e) {
        ...
        if (typeof btoa === 'function') {
          var c = btoa(unescape(encodeURIComponent(JSON.stringify(n))));
          var l = 'sourceMappingURL=data:application/json;charset=utf-8;base64,'.concat(
            c
          );
          var A = '/*# '.concat(l, ' */');
          var a = n.sources.map(function (r) {
            return '/*# sourceURL='.concat(n.sourceRoot || '').concat(r, ' */');
          });
          return [i].concat(a).concat([A]).join('\n');
        }
        return [i].join('\n');
      };
    },
    ...
    93379: (r, o, e) => {
      ...
      function l(r, o) {
        ...
        for (var i = 0; i < r.length; i++) {
          var l = r[i];
          var A = o.base ? l[0] + o.base : l[0];
          var a = e[A] || 0;
          var s = ''.concat(A, ' ').concat(a);
          e[A] = a + 1;
          var d = c(s);
          var u = { css: l[1], media: l[2], sourceMap: l[3] };
          if (d !== -1) {
            n[d].references++;
            n[d].updater(u);
          } else {
            n.push({ identifier: s, updater: f(u, o), references: 1 });
          }
          t.push(s);
        }
        return t;
      ...
      function f(r, o) {
        ...
        if (o.singleton) {
          var n = b++;
          e = C || (C = A(o));
          t = d.bind(null, e, n, false);
          i = d.bind(null, e, n, true);
        } else {
          e = A(o);
          t = u.bind(null, e, o);
          i = function r() {
