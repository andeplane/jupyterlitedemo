  ...
  [6777],
  {
    63971: (r, e, n) => {
      ...
      d.push([
        ...
        {
          version: 3,
          sources: ['webpack://./node_modules/codemirror/theme/duotone-dark.css'],
          names: [],
          mappings:
    ...
    94015: (r) => {
      ...
      function a(r, e) {
        ...
        var c, d;
        try {
          for (n = n.call(r); !(t = (c = n.next()).done); t = true) {
            o.push(c.value);
      ...
      r.exports = function r(n) {
        ...
        if (typeof btoa === 'function') {
          ...
          var d = 'sourceMappingURL=data:application/json;charset=utf-8;base64,'.concat(
            c
          );
          var s = '/*# '.concat(d, ' */');
          var i = a.sources.map(function (r) {
    ...
    93379: (r, e, n) => {
      ...
      function d(r, e) {
        ...
        for (var t = 0; t < r.length; t++) {
          var d = r[t];
          var s = e.base ? d[0] + e.base : d[0];
          var i = n[s] || 0;
          var u = ''.concat(s, ' ').concat(i);
          n[s] = i + 1;
          var m = c(u);
          var A = { css: d[1], media: d[2], sourceMap: d[3] };
          if (m !== -1) {
            a[m].references++;
            a[m].updater(A);
          } else {
            a.push({ identifier: u, updater: p(A, e), references: 1 });
          }
          o.push(u);
        }
        return o;
      ...
      function p(r, e) {
        ...
        if (e.singleton) {
          var a = l++;
          n = f || (f = s(e));
          o = m.bind(null, n, a, false);
          t = m.bind(null, n, a, true);
        } else {
          n = s(e);
          o = A.bind(null, n, e);
          t = function r() {
