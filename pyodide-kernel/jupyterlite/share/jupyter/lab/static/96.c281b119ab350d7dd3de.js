(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [96],
  {
      ...
      t.exports = function (t) {
        ...
        c.toString = function c() {
          return this.map(function (c) {
            var n = t(c);
            if (c[2]) {
              return '@media '.concat(c[2], ' {').concat(n, '}');
            }
            return n;
          }).join('');
        };
    ...
    94015: (t) => {
      ...
      function e(t, c) {
        if (!t) return;
        if (typeof t === 'string') return o(t, c);
      ...
      function o(t, c) {
        if (c == null || c > t.length) c = t.length;
        for (var n = 0, e = new Array(c); n < c; n++) {
          e[n] = t[n];
        }
        return e;
      }
      function r(t, c) {
        ...
        var A, s;
        try {
          for (n = n.call(t); !(o = (A = n.next()).done); o = true) {
            e.push(A.value);
            if (c && e.length === c) break;
          }
        } catch (i) {
          r = true;
          s = i;
      ...
      t.exports = function t(n) {
        ...
        if (typeof btoa === 'function') {
          ...
          var i = '/*# '.concat(s, ' */');
          var m = r.sources.map(function (t) {
            return '/*# sourceURL='.concat(r.sourceRoot || '').concat(t, ' */');
          });
          return [o].concat(m).concat([i]).join('\n');
        }
        return [o].join('\n');
      };
    },
    ...
    93379: (t, c, n) => {
      ...
      var e = (function t() {
        ...
        return function t() {
          if (typeof c === 'undefined') {
            c = Boolean(window && document && document.all && !window.atob);
          }
          return c;
        };
      })();
      ...
      function s(t, c) {
        ...
        for (var o = 0; o < t.length; o++) {
          var s = t[o];
          var i = c.base ? s[0] + c.base : s[0];
          var m = n[i] || 0;
          var a = ''.concat(i, ' ').concat(m);
          n[i] = m + 1;
          var l = A(a);
          ...
          if (l !== -1) {
            ...
            r.push({ identifier: a, updater: B(u, c), references: 1 });
          }
          e.push(a);
        }
        return e;
      ...
      function B(t, c) {
        ...
        if (c.singleton) {
          var r = d++;
          n = f || (f = i(c));
          e = l.bind(null, n, r, false);
          o = l.bind(null, n, r, true);
        } else {
          n = i(c);
          e = u.bind(null, n, c);
          o = function t() {
      ...
      t.exports = function (t, c) {
        c = c || {};
        if (!c.singleton && typeof c.singleton !== 'boolean') {
          c.singleton = e();
        }
        t = t || [];
        var n = s(t, c);
...
//# sourceMappingURL=96.c281b119ab350d7dd3de.js.map?v=c281b119ab350d7dd3de
